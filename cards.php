...
LEFT JOIN users_cards
	ON users_cards.id_card = cards.id_card
LEFT JOIN users
	ON users.id_user = users_cards.id_user;
EOD;
...
$datos = "<ol id=\"card_list\">";
while($card = mysqli_fetch_assoc($result)){
	$datos .= <<<EOD
<li class="card_item">
	<p><strong>CardID:</strong> {$card["id_card"]}</p>
